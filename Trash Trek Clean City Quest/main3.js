    ...
    setTimeout(function() {
      popup.style.display = 'none'; 
       gameinterval = setInterval(()=>{
        ...
        if(timer == 25){
            star3.style.webkitTextFillColor = 'transparent';
            star30.style.webkitTextFillColor = 'transparent';
        }
        if(timer == 20){
            star2.style.webkitTextFillColor = 'transparent';
            star20.style.webkitTextFillColor = 'transparent';
        }
        if(timer == 10){
            star1.style.webkitTextFillColor = 'transparent';
            star10.style.webkitTextFillColor = 'transparent';
        }
...
let star30 = document.querySelector(".star30")
...
replayBtn.onclick = function(){
    ...
    star1.style.webkitTextFillColor = '#6c0056';
    star2.style.webkitTextFillColor = '#6c0056';
    star3.style.webkitTextFillColor = '#6c0056';
